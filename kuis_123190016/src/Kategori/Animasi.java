 ...
 */
public class Animasi extends InputNilai implements Perhitungan {
    public Animasi(String nama,String sekolah,int nilaiSatu,int nilaiDua,int nilaiTiga,int nilaiEmpat){
    ...
    public double nilaiTotal() {
        return(0.15*super.nilaiSatu)+(0.35*super.nilaiDua)+(0.35*super.nilaiTiga)+(0.15*super.nilaiEmpat);
    }

    @Override
    public String keterangan() {
        if(this.nilaiTotal()>=85)
            return"LULUS\n "+this.nama+" telah LULUS SELEKSI Perlombaan Animasi/n";
        else
            return"GAGAL\n "+this.nama+" TIDAK LULUS SELEKSI Perlombaan Animasi";
    }
}
